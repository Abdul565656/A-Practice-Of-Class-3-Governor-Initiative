          ...
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input type="text" id="name" name="name" className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition duration-200" placeholder="John Doe" />
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                <input type="email" id="email" name="email" className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition duration-200" placeholder="john@example.com" />
              </div>
            </div>
            <div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">123 Business Ave, Suite 100<br />San Francisco, CA 94107</p>
          </div>
        </div>
      </div>
    </section>
